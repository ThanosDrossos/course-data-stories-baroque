...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-14.rq"
--8<-- "../baroque-paintings/cbdd-query-14.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-14.rq"
--8<-- "../baroque-paintings/cbdd-query-14.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-01.rq"
--8<-- "../baroque-paintings/cbdd-query-01.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-01.rq"
--8<-- "../baroque-paintings/cbdd-query-01.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-02.rq"
--8<-- "../baroque-paintings/cbdd-query-02.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-02.rq"
--8<-- "../baroque-paintings/cbdd-query-02.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-03.rq"
--8<-- "../baroque-paintings/cbdd-query-03.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-03.rq"
--8<-- "../baroque-paintings/cbdd-query-03.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-13.rq"
--8<-- "../baroque-paintings/cbdd-query-13.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-13.rq"
--8<-- "../baroque-paintings/cbdd-query-13.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-04.rq"
--8<-- "../baroque-paintings/cbdd-query-04.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-04.rq"
--8<-- "../baroque-paintings/cbdd-query-04.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-05.rq"
--8<-- "../baroque-paintings/cbdd-query-05.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-05.rq"
--8<-- "../baroque-paintings/cbdd-query-05.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-06.rq"
--8<-- "../baroque-paintings/cbdd-query-06.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-06.rq"
--8<-- "../baroque-paintings/cbdd-query-06.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-07.rq"
--8<-- "../baroque-paintings/cbdd-query-07.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-07.rq"
--8<-- "../baroque-paintings/cbdd-query-07.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-08.rq"
--8<-- "../baroque-paintings/cbdd-query-08.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-08.rq"
--8<-- "../baroque-paintings/cbdd-query-08.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-09.rq"
--8<-- "../baroque-paintings/cbdd-query-09.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-09.rq"
--8<-- "../baroque-paintings/cbdd-query-09.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-10.rq"
--8<-- "../baroque-paintings/cbdd-query-10.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-10.rq"
--8<-- "../baroque-paintings/cbdd-query-10.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-11.rq"
--8<-- "../baroque-paintings/cbdd-query-11.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-11.rq"
--8<-- "../baroque-paintings/cbdd-query-11.rq"
```
///
...
/// details | **Show SPARQL query**
    type: plain
``` sparql linenums="1" title="cbdd-query-12.rq"
--8<-- "../baroque-paintings/cbdd-query-12.rq"
```
///

/// details | **Show query result**
    type: plain
``` shmarql linenums="1" title="cbdd-query-12.rq"
--8<-- "../baroque-paintings/cbdd-query-12.rq"
```
///
